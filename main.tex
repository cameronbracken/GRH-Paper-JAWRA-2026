...
\begin{figure}
    ...
    \caption{Cumulative forebay error under an idealized pass-inflow stress test with a neutral starting position. Lines show the median across forecast issues and shaded bands span the 2.5th to 97.5th percentiles. Dashed lines mark the $\pm$0.5 foot ($\approx$15 cm) forebay operating band.}
    \label{fig:cum-error}
\end{figure}

Figure \ref{fig:prob-exeed-threshold} shows the corresponding probability of leaving the forebay band. During the first 24 hours, forecast B has lower exceedance probability than A at all three dams: 30.8\% versus 50.0\% at Wilder, 47.5\% versus 73.0\% at Bellows Falls, and 53.7\% versus 76.3\% at Vernon. The in-house forecast is available only through the day-ahead period and has probabilities of 53.9\%, 67.6\%, and 73.2\%, respectively. By 48 hours, the two commercial products converge to 58.1--76.2\% across the three dams; by 72 hours, probabilities range from 73.1\% to 90.3\%. Thus B provides a clearer advantage over the first day, while neither commercial product can be passed through without intervention over longer horizons. This distinction was not apparent from the aggregate metrics alone.

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{6a-threshold-1day.png}
    \caption{Probability of exceeding the $\pm$0.5 foot ($\approx$15 cm) forebay operating band at daily lead times under the idealized pass-inflow stress test. Each forecast issue begins from a neutral forebay position. The in-house forecast ends after the day-ahead period.}
